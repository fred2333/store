...
<html>
  <head>
	...
	-->
	<link rel="stylesheet" type="text/css" href="<c:url value='/Front/css/cart/showitem.css'/>">
...
<script type="text/javascript">
  ...
  <body>
  <c:choose>
  	<c:when test="${empty cartItemList }">无订单！</c:when>
  	<c:otherwise>
...
<c:forEach items="${cartItemList }" var="cartItem">
	...
	<tr>
		<td colspan="6">
			<input id="addr" type="text" name="address" readonly="readonly" value="${sessionScope.sessionUser.address}" required="required"/>
		</td>
	</tr>
	<tr>
