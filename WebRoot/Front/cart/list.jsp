...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="<c:url value='/Front/css/cart/list.css'/>">
	...
	$(".jian").click(function() {
		...
		if(quantity == 1) {
			if(confirm("您是否真要删除该条目？")) {
				location = "/Horizon/CartItemServlet?method=batchDelete&cartItemIds=" + id;
			}
		} else {
...
function batchDelete() {
	...
	location = "/Horizon/CartItemServlet?method=batchDelete&cartItemIds=" + cartItemIdArray;
}
...
<c:choose>
	...
	<table width="95%" align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td align="right">
				<img align="top" src="<c:url value='/Front/images/icon_empty.png'/>"/>
			</td>
			<td>
