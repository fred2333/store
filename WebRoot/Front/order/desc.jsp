						...
						<tr style="padding-top: 20px; padding-bottom: 20px;">
							<td class="td" width="400px">
								<div class="Productname">
								  ...
								  <a href="<c:url value='/ProductServlet?method=load&productid=${item.product.productid }&shopid=${item.product.shopid }'/>">${item.product.productName }</a>
								</div>
							</td>
							<td class="td" >
								<span>&yen;${item.product.currPrice }</span>
							</td>
							<td class="td">
