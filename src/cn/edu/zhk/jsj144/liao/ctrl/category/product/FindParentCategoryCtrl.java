...
public class FindParentCategoryCtrl extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * Constructor of the object.
	 */
	public FindParentCategoryCtrl() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher rd=request.getRequestDispatcher("/Back_Shop/ma_product/addProduct.jsp");
